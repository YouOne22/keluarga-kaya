...
export type Bill = { id: string; family_id: string; name: string; amount: number; due_day: number; category_id: string | null; notes: string; is_active: boolean; created_by: string | null; created_at: string; updated_at: string; };
export type BillPayment = { id: string; bill_id: string; family_id: string; month: string; amount: number; account_id: string | null; note: string; paid_at: string; created_by: string | null; };

// ===== Installments (Cicilan/Angsuran) =====
export type Installment = { id: string; family_id: string; name: string; total_amount: number; monthly_amount: number; tenor_total: number; tenor_paid: number; start_date: string; account_id: string | null; category_id: string | null; notes: string; status: string; created_by: string | null; created_at: string; updated_at: string; };
export type InstallmentPayment = { id: string; installment_id: string; family_id: string; tenor_number: number; amount: number; account_id: string | null; note: string; paid_at: string; created_by: string | null; };

// ===== Debts (Hutang/Piutang) =====
export type Debt = { id: string; family_id: string; type: "debt" | "receivable"; person_name: string; amount: number; paid_amount: number; due_date: string | null; notes: string; status: string; created_by: string | null; created_at: string; updated_at: string; };
export type DebtPayment = { id: string; debt_id: string; family_id: string; amount: number; account_id: string | null; note: string; paid_at: string; created_by: string | null; };
